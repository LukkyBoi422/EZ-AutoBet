...
The goal for this project is a simple auto betting tool that doesnt require any configuration from the user and is already configured setup and easy to use with just one button to press then it starts autobetting
